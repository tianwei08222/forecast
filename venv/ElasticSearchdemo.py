...
if __name__ == '__main__':
    ...
    for dir in range(1,10):
        ...
        for date_num in range(29,-1,-1):
            ...
            forecast = forecast_workexper_jobnum_salary(dir,today)
            ...
            dic['zero_salary'] = aver(zero_all)
            dic['one_salary'] = aver(one_all)
            dic['two_salary'] = aver(two_all)
            dic['three_salary'] = aver(three_all)
            dic['four_salary'] = aver(four_all)
            dic['five_salary'] = aver(five_all)
        ...
        for day in range(1,8):
            dic = {}
            dic['date'] = getDatetimeNextday(day)
            dic['zero_jobnum'] = zero_jobnum[day-1]
            dic['one_jobnum'] = one_jobnum[day-1]
            dic['two_jobnum'] = two_jobnum[day-1]
            dic['three_jobnum'] = three_jobnum[day-1]
            dic['four_jobnum'] = four_jobnum[day-1]
            dic['five_jobnum'] = five_jobnum[day-1]

            dic['zero_salary'] = zero_salary[day-1]
            dic['one_salary'] = one_salary[day-1]
            dic['two_salary'] = two_salary[day-1]
            dic['three_salary'] = three_salary[day-1]
            dic['four_salary'] = four_salary[day-1]
            dic['five_salary'] = five_salary[day-1]
            res.append(dic)
        print(res)
        res = str(res)
        res = res.replace('"', '\\"')
    ...
    # forecast = forecast_workexper_jobnum_salary()
    # final_results = forecast.search(today)
    # print(forecast.es_search_options)
    # for it in final_results:
    #     print(it)
